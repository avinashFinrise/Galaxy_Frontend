...
const ARBInrAedRate = () => {
    ...
    const addArbAccountData = async (e) => {
        ...
        const validationErrors = [
            { condition: !arbRateRowData.startdate, message: "Start date is required." },
            { condition: !arbRateRowData.groupname, message: "Groupname is required." },
            { condition: !arbRateRowData.userid, message: "Userid is required." },
        ];
    ...
    const rowStyle = (params) => {
          ...
          if (params.data && params.data.inr==0&&params.data.usd==0 ) {
    ...
    const inputdata = [
        ...
        {
            type: "select", name: "groupname", placeholder: "select groupname", value: `${arbRateRowData.groupname}`,
            option: apiData.groupname.map((val) => <Option key={val.id} value={val.groupName}>
                {val.groupName}
            </Option>)
        },
        {
            type: "select", name: "userid", placeholder: "select userid", value: `${arbRateRowData.userid}`,
