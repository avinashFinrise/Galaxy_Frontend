...
const PositionGroupWiseTable = ({ exchange }) => {
    ...
    <div className={`popup-tableSection ${tableStyle.popupTableSection}`}>
      ...
      >
        <div className={tableStyle.noteSection}>
          <p style={{ color: "red" }}>NOTE: Please Select Symbol First</p>
        </div>
        <div className={tableStyle.noteSection}>
          <p>NOTE: As per Group wise /{exchange} selected</p>
        </div>
        <div
...
export default PositionGroupWiseTable;
